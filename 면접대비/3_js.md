...
- `객체 리터럴 🔥`
  ...
  - 전역 객체
    ...
    - 브라우저에서는 window 객체, Node.js에서는 global 객체와 같은 호스트 객체들도 전역 객체 중 
...
- `브라우저 렌더링 과정 🔥`
  - 주소창에 Google.com을 입력하면?
    - 대기열, 캐싱, DNS, 라우팅, ARP(IP에 해당하는 Mac주소 찾음), 초기연결을 거쳐 컨텐츠 다운, 브라우저 렌더링 발생 (캡슐화, 비캡슐화 과정을 거침)
  - 브라우저의 렌더링 과정 🔥
...
- `비동기 프로그래밍 🔥`
  ...
  - 마이크로태스크 큐에 대해 🔥🔥
    - 프로미스의 후속 처리 메서드의 콜백 함수는 태스크 큐 가 아니라 마이크로태스크 큐 에 저장
