...
- `DOCTYPE 🔥`
  ...
  - meta 태그에 대해?
    ...
    - 모바일 기기에서 웹 사이트를 보기 좋게 <a href="">viewport</a> 같은 것을 설정 할 수있는
  - meta 태그의 요소
    ```
    // 예시
    <meta charset="utf-8" />
...
- `웹 표준 및 웹 접근성 🔥`
  ...
  - HTML5의 특징
    ...
    - <a href="">로컬 스토리지</a>와 <a href="">세션 스토리지</a>
    - <a href="">웹소켓</a>
    - <a href="">시맨틱 태그</a>
    - <a href="">캔버스</a>(2d,3d)
    - 지리적인 <a href="">위치 정보</a>
...
- `SVG란 ? 🔥`
  - SVG에 대해
    ...
    - 2011년 <a href="">W3C 표준</a>이 되었다.
    - XML 포맷으로 파일이 작성되므로 <a href="">JS나 CSS로 조작</a>이 가능하다.
    - 단점은 <a href="">이미지가 복잡할수록 SVG만의 장점은 감소</a>한다.
  - SVG 내부 도형에 대해?
