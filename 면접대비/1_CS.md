- `프로세스와 스레드 🔥`
  - 프로세스와 스레드의 차이
    ...
    - 스레드 :  프로세스안에 실행 <a href="">흐름의 단위</a>, 할당받은 <a href="">자원을 다른 스레드와 공유</a>

- `싱글 스레드와 멀티 스레드 🔥`
  - 싱글 스레드 장단점
    - 장점 : 스레드 간의 작업전환 X -> <a href="">단순 작업엔 유리</a>
    - 단점 : 여러 CPU를 활용 X -> <a href="">동시 작업 할 수 X</a>
  - 멀티 스레드 장단점
    - 장점 : 1) 새로운 프로세스보다 기존 프로세스에서 <a href="">스레드 생성이 더 빠름</a>, 2) 프로세스의 <a href="">자원을 공유</a>하여 효율적, 3) 프로세스 작업전환보다 <a href="">스레드 작업전환이 더 빠름</a>.
