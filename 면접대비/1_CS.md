...
- `business logic 🔥`
  - business logic 이란?
      - 프로그램의 핵심 로직
      - <a href="">어떻게 데이터가 생성되고 저장되고 수정되는지</a> 등을 정의한 것
...
- 크로스 브라우징에 대해
  ...
  - 작업이 필요한 이유 : 브라우저 마다 <a href="">랜더링 엔진이 달라서</a> 작동되지 않는 HTML5, CSS, Javascript 코드가 존재함
...
- `타입과 인터페이스 🔥🔥🔥`
  - 동적 타이핑 : 변수의<a href=""> 타입을 미리 지정하지 않고</a>, 런타임에 할당된 값에 따라 <a href="">자동으로</a> 타입이 결정 (자바스크립트)
