...
- `DOCTYPE 🔥`
  - DOCTYPE에 대해
    - HTML 뒤에 태그들이 <a href="">HTML5의 문법에 따라 작성</a>되었음을 <a href="">브라우저에 알림</a> (문서형식을 정의)
  - meta 태그에 대해?
...
- `웹 표준 및 웹 접근성 🔥`
  ...
  - 시멘틱 태그
    ...
    - HTML로 만든 문서에 추가적으로 의미를 부여, 서로 관계가 있는 정보를 파악하고 <a href="">콘텐츠 맥락을 쉽게 파악 하게함</a>
...
- `그 외 🔥`
  ...
  - 이미지 크기가 커서 렌더링 속도가 느려지는 것을 개선하기 위한 방법
...
- `SVG란 ? 🔥`
  ...
  - SVG 내부 도형에 대해? - <a href="">rect, circle, polyline, path</a>
    <br />
...
- `CSS 가상요소(Pseudo-Element)에 대해`

  - <a href="">HTML 요소에 존재하지 않는 가상의 요소</a> 를 생성하고, 이를 <a href="">스타일링</a> 하기 위한 기술입니다
  - 가상 요소는 특히 <a href="">디자인적인 요소</a> 에 활용되며, 예를 들어 콘텐츠의 앞이나 뒤에 아이콘, 라인, 따옴표, 특수문자 등을 추가할 수 있습니다.
  - ::before
...
- `@media 쿼리 미디어 유형`
  - screen(기기에서 보는 스크린), speech(스크린 리더용), print(프린터용), all
