- 리액트는 라이브러리인가요 프레임워크인가요
  ...
  - 프레임워크, 라이브러리 차이 : <a href="">흐름의 차이</a> [ 프레임워크 --(호출)--> 개발자 // 개발자 --(호출)--> 라이브러리 ] 
...
- 리액트에서 함수형 컴포넌트라고 부르지 않고 함수 컴포넌트라고 부르는 이유가 무엇인가요🔥
  ...
  - <a href="">함수형 프로그래밍은 순수 함수를 지향</a>하는데, <a href="">함수 컴포넌트는 훅으로 인해</a> 많은 사이드 이펙트(부수효과)를 일으켜 <a href="">함수형 프로그래밍과는 거리가 멀다</a>
...
- 리덕스의 기본 3 원칙은? 🔥
  - 어플리케이션 <a href="">상태는 모두 한곳에서</a> 집중 관리하여 일관성 유지 (<a href="">단일 저장소</a>)
...
- TTV, TTI
  ...
  - 개발시 주의 점
    - <a href="">CSR</a>의 경우 어떻게 하면 <a href="">효율적으로 코드스플리팅</a>을 하여 <a href="">첫 번째로</a> 사용자가 보기 위해서 필요한 정말 <a href="">필수적인 html 요소만</a> 보낼 수 있을지 고민
